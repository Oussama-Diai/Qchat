...
public:
    ...
    void setupUi(QWidget *FenClient)
    {
        ...
        label_5->setPixmap(QPixmap(QString::fromUtf8("../build-Client-Desktop-Debug/chat.png")));
    ...
    {
        FenClient->setWindowTitle(QApplication::translate("FenClient", "ZeroChat - Client", nullptr));
        label->setText(QApplication::translate("FenClient", "IP du serveur :", nullptr));
        serveurIP->setText(QApplication::translate("FenClient", "127.0.0.1", nullptr));
        ...
        label_6->setText(QApplication::translate("FenClient", "DIAI_Chat", nullptr));
